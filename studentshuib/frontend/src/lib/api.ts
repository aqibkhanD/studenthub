...
export const authApi = {
  ...
  changePassword: (data: Record<string, string>)                              => api.put('/auth/password', data),
...
export const studentApi = {
  ...
  submit:      (data: Record<string, unknown>)          => api.post('/student/submissions', data),
  resubmit:    (ref: string, data: Record<string, unknown>) => api.put(`/student/submissions/${ref}`, data),
...
export const superApi = {
  ...
  createFT:         (data: Record<string, unknown>)            => api.post('/super/form-types', data),   // legacy alias
  updateFT:         (id: number, data: Record<string, unknown>)=> api.put(`/super/form-types/${id}`, data),
  ...
  createField:      (id: number, data: Record<string, unknown>) => api.post(`/super/form-types/${id}/fields`, data),
  updateField:      (id: number, fid: number, data: Record<string, unknown>) => api.put(`/super/form-types/${id}/fields/${fid}`, data),
